...
!> The c_array_t type and related functions
module aero_c_array
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  type(c_ptr) function aero_bridge_c_array_clone( array_c ) bind(c)
    use iso_c_binding
    type(c_ptr), value :: array_c
  end function aero_bridge_c_array_clone

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine aero_bridge_c_array_free( array_c ) bind(c)
    use iso_c_binding
    type(c_ptr), value :: array_c
  end subroutine aero_bridge_c_array_free

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine aero_bridge_c_array_copy_in( array_c, input_c ) bind(c)
    use iso_c_binding
    type(c_ptr), value :: array_c
    type(c_ptr), value :: input_c
  end subroutine aero_bridge_c_array_copy_in

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine aero_bridge_c_array_copy_out( array_c, output_c ) bind(c)
    use iso_c_binding
    type(c_ptr), value :: array_c
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  pure integer function array_size( this )
    ...
    array_size = aero_bridge_c_array_size( this%array_ )
